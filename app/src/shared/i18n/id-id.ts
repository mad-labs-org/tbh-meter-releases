...
export const DICT: Partial<Record<DictKey, string>> = {
  ...
  "diagnostics.failed": "Gagal mengumpulkan diagnostik.",
  "diagnostics.copyToClipboard": "Salin ke papan klip",
  "diagnostics.copied": "Tersalin!",
  "diagnostics.copyFailed": "Gagal menyalin — periksa izin papan klip.",
